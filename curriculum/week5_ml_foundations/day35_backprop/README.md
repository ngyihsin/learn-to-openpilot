...
**Sanity check as you go** (uses the reference network shape; should print `[[3.]]`):
```bash
...
The decisive test is `test_backward_matches_numerical_gradient` — if it passes, your backprop is
