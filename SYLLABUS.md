...
toolkit for the CV/VLM research ahead, so it's the deepest week — seven core days plus ten
...
| 28e | **Temporal models: seeing motion** | pytest | Prove one frame can't measure speed; fix it with frame stacking and an explicit-state GRU (export-ready `step`) | ✅ |
